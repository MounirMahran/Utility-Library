...
{
    clsUtil::Srand();
    cout << clsUtil::GenerateRandomNumber(1, 10) << endl;
    cout << clsUtil::GenerateRandomCharacter(clsUtil::CapitalLetter) << endl;
    cout << clsUtil::GenerateWord(clsUtil::Mix, 8) << endl;
    cout << clsUtil::GenerateKey(clsUtil::Mix) << endl;
    clsUtil::GenerateKeys(clsUtil::Mix, 10);
    ...
    string Arr4[5];
    clsUtil::FillArrayWithRandomWords(Arr4, clsUtil::Mix, 8, 5);
    cout << "\nArray after fill:\n";
    for (int i = 0; i < 5; i++)
    {
        cout << Arr4[i] << endl;
    ...
    string Arr5[5];
    clsUtil::FillArrayWithRandomKeys(Arr5, clsUtil::Mix, 5);
    ...
    string Text = "Moataz Mounir Mahran";
